...

{
...

    {
...

        {
            ...
            var act = item.Send("Veniamin");

            Assert.Equal($"Hi Veniamin, can you check American Pie(1999) to watch? I want to know your opinion about this film))", act);
...

        {
            ...
            var item = new Film(1984, "American Pie", "America");

            var act = item.Watch();

            Assert.Equal($"Now i am watching a film, named American Pie, which came out in 1999 from America", act);
